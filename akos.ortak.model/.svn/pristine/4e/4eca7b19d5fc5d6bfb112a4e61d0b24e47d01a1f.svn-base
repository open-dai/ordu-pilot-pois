...
@Audited
public class YapiAda extends BaseObject implements IVersionable,ITransactionable,IHistoricalable {
	 ...
	 * @uml.associationEnd  inverse="yapiAda:com.sampas.akos.ortak.model.KurumSabit"
	 */
	...
	/**
	 * @uml.property  name="yapiAdasiVasfi"
	 */
	private String yapiAdasiVasfi = "";

	/**
	 * Getter of the property <tt>yapiAdasiVasfi</tt>
	 * @return  Returns the yapiAdasiVasfi.
	 * @uml.property  name="yapiAdasiVasfi"
	 */
	public String getYapiAdasiVasfi() {
		return yapiAdasiVasfi;
	}

	/**
	 * Setter of the property <tt>yapiAdasiVasfi</tt>
	 * @param yapiAdasiVasfi  The yapiAdasiVasfi to set.
	 * @uml.property  name="yapiAdasiVasfi"
	 */
	public void setYapiAdasiVasfi(String yapiAdasiVasfi) {
		this.yapiAdasiVasfi = yapiAdasiVasfi;
	}
