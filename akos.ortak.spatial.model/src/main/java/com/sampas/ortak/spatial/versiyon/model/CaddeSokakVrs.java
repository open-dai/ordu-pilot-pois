...
public class CaddeSokakVrs extends BaseVersionObject {
	...
	/**
	 * @uml.property  name="caddeSokakTurId"
	 */
	private Long caddeSokakTurId;

	/**
	 * Getter of the property <tt>caddeSokakTurId</tt>
	 * @return  Returns the caddeSokakTurId.
	 * @uml.property  name="caddeSokakTurId"
	 */
	public Long getCaddeSokakTurId() {
		return caddeSokakTurId;
	}

	/**
	 * Setter of the property <tt>caddeSokakTurId</tt>
	 * @param caddeSokakTurId  The caddeSokakTurId to set.
	 * @uml.property  name="caddeSokakTurId"
	 */
	public void setCaddeSokakTurId(Long caddeSokakTurId) {
		this.caddeSokakTurId = caddeSokakTurId;
	}
