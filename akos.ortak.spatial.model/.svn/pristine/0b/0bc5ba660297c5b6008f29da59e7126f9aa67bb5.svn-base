...
public class BinaNitelikVrs extends BaseVersionObject {
	 ...
	 * @uml.property  name="toplamKatSayisi"
	 */
	private Integer yolKotuAltiYukseklik;
	 ...
	 * @uml.property  name="toplamKatSayisi"
	 */
	public Integer getYolKotuAltiYukseklik() {
	 ...
	 * @uml.property  name="toplamKatSayisi"
	 */
	public void setYolKotuAltiYukseklik(Integer yolKotuAltiYukseklik) {
