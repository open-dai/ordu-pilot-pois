...
public class CoordinateConversion
{
  ...
  public  double[] inverseMercator (double x, double y) {
  ...
  public double[] utm2LatLon(String UTM,Double easting,Double northing)
  {
    UTM2LatLon c = new UTM2LatLon();
    return c.convertUTMToLatLong(UTM,easting,northing);
  }
  ...
  private class UTM2LatLon
  {
    ...
    public double[] convertUTMToLatLong(String UTM,Double easting,Double northing)
    {
      double[] latlon = { 0.0, 0.0 };
