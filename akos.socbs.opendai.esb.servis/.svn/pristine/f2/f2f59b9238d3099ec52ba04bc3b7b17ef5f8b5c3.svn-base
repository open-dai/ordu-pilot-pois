...
public class ComplainType  {
    ...
    private GeoInfoMngmnt.CityDynamics.V1.ImageType complainImage;
    ...
    public ComplainType(
           ...
           GeoInfoMngmnt.CityDynamics.V1.CoordinateType coordinate,
           GeoInfoMngmnt.CityDynamics.V1.ImageType complainImage) {
           this.name = name;
     ...
     */
    public GeoInfoMngmnt.CityDynamics.V1.ImageType getComplainImage() {
        return complainImage;
    }
     ...
     * @param complainImage
     */
    public void setComplainImage(GeoInfoMngmnt.CityDynamics.V1.ImageType complainImage) {
        this.complainImage = complainImage;
    }
