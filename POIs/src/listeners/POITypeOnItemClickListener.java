...
public class POITypeOnItemClickListener implements OnItemClickListener, OnItemSelectedListener, OnClickListener{
	...
	public POITypeOnItemClickListener(Context c, MapMarker m, DataProvider p, Vector<POIData> d, GoogleMap gMap)
	{
		marker = m;
		provider = p;
		allData = d;
