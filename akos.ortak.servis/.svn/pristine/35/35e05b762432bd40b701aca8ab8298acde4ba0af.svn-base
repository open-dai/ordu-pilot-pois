...
public interface OrtakServis {
	//public abstract List<Kullanicilar> testLogin(String p_username,String p_password);
	...
	public abstract void saveOrUpdateKullanimSekliList(
	...
	public abstract List<Adres> readAllAdresByAdresSorgulama(
			MahalleCaddeSokak mahalleCaddeSokak, Adres adres,
	...
	public abstract List<Bagimsiz> readAllBagimsizByAdresSorgulama(Adres adres,
			KurumSabit kurumSabit, int baslangicKaydi, int maksimumKayitSayisi);

	public abstract List<CaddeSokak> readAllCaddeSokakByAdresSorgulama(
			KurumSabit kurumSabit, Mahalle mahalle);
	...
	public abstract List<Mahalle> readAllMahalleByAdresSorgulama(
			KurumSabit kurumSabit);
	...
	public abstract List<Bina> readAllBinaByAdresSorgulama(Adres adres,
			KurumSabit kurumSabit);
	...
	public abstract List<Bagimsiz> readAllBagimsizByKadastroParselSorgulama(
			KurumSabit kurumSabit, KadastroParsel kadastroParsel,
			int baslangicKaydi, int maksimumKayitSayisi);

	public abstract List<Bina> readAllBinaByKadastroSorgulama(
			KadastroParsel kadastroParsel, KurumSabit kurumSabit);

	public abstract Adres readAdresByKadastroSorgulama(Bagimsiz bagimsiz);

	public abstract Bina readBinaByKadastroSorgulama(Bagimsiz bagimsiz);
	...
	public abstract List<Tapu> readAllTapuByKadastroSorgulama(
			KadastroParsel kadastroParsel, KurumSabit kurumSabit);
	...
	public abstract List<KadastroParsel> readKadastroParselByBinaParselSorgulama(
			Bina bina, KurumSabit kurumSabit);
	...
	public abstract List<String> readAltKapiNoByCaddeSokakKapiNo(KurumSabit kurumsabit,CaddeSokak caddeSokak,Number kapiNo);
