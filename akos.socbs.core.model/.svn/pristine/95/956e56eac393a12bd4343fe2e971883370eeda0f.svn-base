 ...
 *
 * @source $URL: http://svn.geotools.org/tags/2.4.4/modules/extension/graph/src/main/java/org/geotools/graph/io/standard/TextfileReaderWriter.java $
 */
public abstract class SmpTextfileReaderWriter extends SmpAbstractReaderWriter 
   ...
   * 
   * @see IGraphGenerator#read()
   */
  public IGraph read() throws Exception {
    //get the underlying generator
    IGraphGenerator generator = (IGraphGenerator)getProperty(GENERATOR);
   ...
   */
  protected void writeNode(Writer out, INode n) {}
  ...
  /**
	 ...
	 */
  protected void writeEdge(Writer out, IEdge e) {}
