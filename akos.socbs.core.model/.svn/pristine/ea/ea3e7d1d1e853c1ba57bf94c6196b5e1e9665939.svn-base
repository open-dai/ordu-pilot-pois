 ...
 * @source $URL: http://svn.geotools.org/tags/2.4.4/modules/unsupported/mysql/src/main/java/org/geotools/data/mysql/MySQLDataStoreFactory.java $
 */
...
//    }
    ...
    public Param[] getParametersInfo() {
        return new Param[] {
            DBTYPE, HOST, PORT, DATABASE, USER, PASSWD, MAXCONN, MINCONN, VALIDATECONN, NAMESPACE, WKBENABLED
        };
    }
