...
/**
 * @source $URL: http://svn.geotools.org/tags/2.4.4/modules/extension/graph/src/main/java/org/geotools/graph/traverse/standard/DirectedBreadthFirstIterator.java $
 */
public class SmpDirectedBreadthFirstIterator extends SmpBreadthFirstIterator {
