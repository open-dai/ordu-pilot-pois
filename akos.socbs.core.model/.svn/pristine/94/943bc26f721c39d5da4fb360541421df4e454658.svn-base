 ...
 *
 * @source $URL: http://svn.geotools.org/tags/2.4.4/modules/extension/graph/src/main/java/org/geotools/graph/structure/Node.java $
 */
public interface INode extends IGraphable {
