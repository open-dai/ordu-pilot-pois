 ...
 * @source $URL: http://svn.geotools.org/tags/2.4.4/modules/unsupported/oracle-spatial/src/main/java/org/geotools/data/oracle/referencing/OracleAuthorityFactory.java $
 */
