...
import com.sampas.socbs.core.tile.toolbox.OutOfBoundsException;
...
//        }
     ...
     * @return
     */
    public BBOX bboxFromGridLocation(int[] gridLoc, int zoomLevel) {
    	
        //double tileWidth = gridWidth / Math.pow(2, gridLoc[2] + gridConstant);
        double tileWidth = resolutions[zoomLevel] * GridCalculator.TILEPIXELS;
