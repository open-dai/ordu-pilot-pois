 ...
 *
 * @source $URL: http://svn.geotools.org/tags/2.4.4/modules/extension/graph/src/main/java/org/geotools/graph/build/line/BasicLineGraphGenerator.java $
 */
public class SmpBasicLineGraphGenerator implements ILineGraphGenerator {
   ...
   */
  public SmpBasicLineGraphGenerator () {
  ...
  public IGraphable add(Object obj) {
    ...
    c = line.p0;
    if ((n1 = (INode)m_coord2node.get(c)) == null) {
    ...
    c = line.p1;
    if ((n2 = (INode)m_coord2node.get(c)) == null) {
      //first time coordinate seen, create node for it
  ...
  public IGraphable get(Object obj) {
    ...
    INode n1 = (INode)m_coord2node.get(line.p0);
    INode n2 = (INode)m_coord2node.get(line.p1);
  ...
  public INode getNode(Coordinate c) {
    return((INode)m_coord2node.get(c));  
  }

  public IEdge getEdge(Coordinate c1, Coordinate c2) {
    INode n1 = (INode)m_coord2node.get(c1);
    INode n2 = (INode)m_coord2node.get(c2);
    
    return(n1.getEdge(n2));  
  }
  
  protected void setObject(IEdge e, Object obj) {
    e.setObject(obj);
  }
