 ...
 *
 * @source $URL: http://svn.geotools.org/tags/2.4.4/modules/extension/graph/src/main/java/org/geotools/graph/io/standard/DBReaderWriter.java $
 */
public abstract class SmpDBReaderWriter extends SmpAbstractReaderWriter {
...
//    System.out.println(getQuery());
   ...
   */
  protected void writeNode(Statement st, INode node) {}
  ...
  /** 
	 ...
	 */
  protected void writeEdge(Statement st, IEdge edge) {}
