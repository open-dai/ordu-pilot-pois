...
public class ArcSDEDataStoreFactory implements DataStoreFactorySpi {
    ...
    static {
        ...
        Integer DEFAULT_PORT = new Integer(5151);
        ...
        Integer MAX_CONNECTIONS = new Integer(ArcSDEConnectionPool.DEFAULT_MAX_CONNECTIONS);
        ...
        Integer TIMEOUT = new Integer(ArcSDEConnectionPool.DEFAULT_MAX_WAIT_TIME);
