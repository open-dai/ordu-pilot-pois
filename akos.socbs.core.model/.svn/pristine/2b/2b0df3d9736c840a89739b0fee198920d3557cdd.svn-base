 ...
 *
 * @source $URL: http://svn.geotools.org/tags/2.4.4/modules/extension/graph/src/main/java/org/geotools/graph/build/line/LineStringGraphGenerator.java $
 */
public class SmpLineStringGraphGenerator extends SmpBasicLineGraphGenerator {
  ...
  protected void setObject(INode n, Object obj) {
