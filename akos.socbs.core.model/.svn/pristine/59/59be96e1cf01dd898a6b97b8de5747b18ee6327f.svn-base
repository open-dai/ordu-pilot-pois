 ...
 * @source $URL: http://svn.geotools.org/tags/2.4.4/modules/unsupported/gml/src/main/java/org/geotools/data/gml/GMLDataStore.java $
 */
@SuppressWarnings("unchecked")
public class GMLDataStore extends AFeatureDataProvider {
