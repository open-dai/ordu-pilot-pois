 ...
 * @source $URL: http://svn.geotools.org/tags/2.4.4/modules/plugin/postgis/src/main/java/org/geotools/filter/SQLEncoderPostgis.java $
 */
@SuppressWarnings("deprecation")
public class SQLEncoderPostgis extends SQLEncoder implements org.geotools.filter.FilterVisitor {
