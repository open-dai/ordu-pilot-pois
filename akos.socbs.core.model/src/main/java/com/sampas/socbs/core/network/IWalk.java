 ...
 */
public class IWalk extends ArrayList implements INodeSequence {
  ...
  //TODO: DOCUMENT ME!!!
  public IPath duplicate() {
    return(new IPath(this));  
  }
   
  public boolean equals(Object other) {
	  if (other instanceof IWalk) return(equals((IWalk)other));
	  return(false);	
	}
	
	public boolean equals(IWalk other) {
	  if (other.size() == size()) {
