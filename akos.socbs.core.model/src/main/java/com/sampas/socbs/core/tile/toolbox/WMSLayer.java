...
public class WMSLayer extends TileLayer {
    ...
    public WMSLayer(String layerName, CacheFactory cacheFactory,
        ...
        if (name.contains(":")) {
        	...
        	this.namespace = layerName.split(":")[0];
		}
    ...
    throws GeoWebCacheException {
        return grids.get(srs).getGridCalculator().bboxFromGridLocation(gridLoc, zoomLevel);
    }
    ...
    ITileDataStore tileDataProvider;
	...
	private List<IRenderer> smpRenderer;
	...
	public int getLayerZoomLevel() {
		// TODO Auto-generated method stub
		return 0;
	}

	public byte[] getTileAtPosition(int tileNoX, int tileNoY,
			IDimension tileDimension) {
		// TODO Auto-generated method stub
		return null;
	}

	public void setLayerZoomLevel(int layerZoomLevel) {
		// TODO Auto-generated method stub
