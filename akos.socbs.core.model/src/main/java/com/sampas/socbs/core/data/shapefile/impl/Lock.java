 ...
 * 
 * @author jeichar
 * @source $URL: http://svn.geotools.org/tags/2.4.4/modules/plugin/shapefile/src/main/java/org/geotools/data/shapefile/Lock.java $
 */
@SuppressWarnings("unchecked")
public class Lock {

    Logger logger = org.geotools.util.logging.Logging.getLogger("com.sampas.socbs.core.data.shapefile.impl");
