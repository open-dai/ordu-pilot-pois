 ...
 * @source $URL: http://svn.geotools.org/tags/2.4.4/modules/plugin/shapefile/src/main/java/org/geotools/index/rtree/fs/FileSystemNode.java $
 */
@SuppressWarnings("unchecked")
public class FileSystemNodeRtree extends NodeRtree {
    
    static final int ENTRY_SIZE = 40;

    private static int pageLen = 0;

    private ParametersRtree params = null;
    private long parentOffset = -1;
    private long offset = -1;
    
    private FileSystemNodeRtree(ParametersRtree params, boolean getFromFree)
    {
	 ...
	 * @param params 
	 */
	public FileSystemNodeRtree(ParametersRtree params) {
        this(params, true);
	}
     ...
     * @param offset
     */
    public FileSystemNodeRtree(ParametersRtree params, long offset)
	...
	/**
	 * @see org.geotools.INode.Node#getParent()
	 */
	public NodeRtree getParent() throws TreeException {
        FileSystemNodeRtree node = null;
        try {
            node = new FileSystemNodeRtree(this.params, this.parentOffset);
        } catch (IOException e) {
	...
	/**
	 * @see org.geotools.INode.Node#save()
     * 
     * <pre>
     * Node page structure:
	...
	/**
	 * @see org.geotools.INode.Node#getEntry(org.geotools.INode.Node)
	 */
	protected Entry getEntry(NodeRtree node) {
		FileSystemNodeRtree fn = (FileSystemNodeRtree)node;
	...
	/**
	 * @see org.geotools.INode.Node#setParent(org.geotools.INode.Node)
	 */
	public void setParent(NodeRtree node) {
        if (node == null) {
            this.parentOffset = -1;
        } else {
            FileSystemNodeRtree fn = (FileSystemNodeRtree)node;
    ...
    public boolean equals(Object obj) {
        FileSystemNodeRtree comp = (FileSystemNodeRtree)obj;
