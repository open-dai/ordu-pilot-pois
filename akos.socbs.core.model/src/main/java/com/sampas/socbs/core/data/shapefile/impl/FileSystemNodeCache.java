 ...
 * @source $URL: http://svn.geotools.org/tags/2.4.4/modules/plugin/shapefile/src/main/java/org/geotools/index/rtree/cachefs/FileSystemNode.java $
 */
@SuppressWarnings({"unused", "unchecked"})
public class FileSystemNodeCache extends NodeRtree {
	
    static final int ENTRY_SIZE = 40;
    private static int pageLen = 0;
    private ParametersCache params = null;
    private boolean flushNeeded;
    private long parentOffset = -1;
    private long offset = -1;

    private FileSystemNodeCache(ParametersCache params, boolean getFromFree) {
     ...
     * @param params
     */
    public FileSystemNodeCache(ParametersCache params) {
        this(params, true);
    }
     ...
     */
    public FileSystemNodeCache(ParametersCache params, long offset)
    ...
    protected void doSave() throws TreeException {
        ...
        try {
            ...
            if (this.isChanged && !this.isLeaf()) {
                FileSystemNodeCache child = null;
    ...
    public boolean equals(Object obj) {
    	FileSystemNodeCache comp = (FileSystemNodeCache) obj;
