 ...
 * @source $URL: http://svn.geotools.org/tags/2.4.4/modules/plugin/shapefile/src/main/java/org/geotools/index/rtree/cachefs/FileSystemPageStore.java $
 */
@SuppressWarnings("unchecked")
public class FileSystemPageStoreCache extends PageStore {
	
    private static final Logger LOGGER = org.geotools.util.logging.Logging.getLogger("com.sampas.socbs.core.data.shapefile.impl");
    ...
    private ParametersCache params = new ParametersCache();
     ...
     */
    public FileSystemPageStoreCache(File file) throws TreeException {
        super();
     ...
     * @throws TreeException
     */
    public FileSystemPageStoreCache(File file, DataDefinition def)
        throws TreeException {
     ...
     * @throws TreeException
     */
    public FileSystemPageStoreCache(File file, DataDefinition def, int cacheSize)
        throws TreeException {
    ...
    private void prepareIndex() throws IOException, TreeException {
        ...
        // Create the root
        FileSystemNodeCache root = new FileSystemNodeCache(this.params);
        root.setLeaf(true);
        root.save();
    ...
    public void setRoot(NodeRtree node) throws TreeException {
        try {
            FileSystemNodeCache n = (FileSystemNodeCache) node;
            n.setParent(null);
    ...
    public NodeRtree getEmptyNode(boolean isLeaf) {
    	FileSystemNodeCache node = new FileSystemNodeCache(params);
        node.setLeaf(isLeaf);
