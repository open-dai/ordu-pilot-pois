 ...
 * @version $Id: FeatureTypeInfo.java 29911 2008-04-11 09:59:47Z groldan $
 * @since 2.5
 * @source $URL:
...
final class FeatureTypeInfo {
     ...
     */
    public FeatureTypeInfo(final FeatureType featureType, final FIDReader fidStrategy,
     ...
     */
    private FeatureTypeInfo(final FeatureType featureType, final FIDReader fidStrategy,
            final boolean isWritable, final boolean isMultiVersion, final boolean isView,
            final PlainSelect definitionQuery, final SeQueryInfo sdeDefinitionQuery) {
