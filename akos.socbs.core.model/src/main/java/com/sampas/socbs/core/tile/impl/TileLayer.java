...
import com.sampas.socbs.core.tile.toolbox.CacheException;
...
public abstract class TileLayer implements ITileLayer {
    ...
    public void setUserLayerId(int userLayerId) {

    	this.userLayerId = userLayerId;
    }
    public long getUserLayerId() {
