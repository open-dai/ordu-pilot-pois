 ...
 * @source $URL: http://svn.geotools.org/tags/2.4.4/modules/plugin/shapefile/src/main/java/org/geotools/index/rtree/cachefs/Parameters.java $
 */
...
public class ParametersCache {
     ...
     * @throws TreeException
     */
    public synchronized FileSystemNodeCache getFromCache(long offset)
        throws IOException, TreeException {
    	FileSystemNodeCache node = null;

        if (this.cache != null) {
            node = (FileSystemNodeCache) this.cache.get(new Long(offset));
        }

        if (node == null) {
            node = new FileSystemNodeCache(this, offset);
     ...
     * @throws TreeException
     */
    public synchronized void putToCache(FileSystemNodeCache node)
        throws TreeException {
        if (this.cache != null) {
     ...
     */
    public synchronized void removeFromCache(FileSystemNodeCache node) {
        if (this.cache != null) {
    ...
    public synchronized void flushCache() throws TreeException {
        ...
        while (iter.hasNext()) {
        	FileSystemNodeCache element = (FileSystemNodeCache) this.cache.get(iter.next());
            element.flush();
        }
