...
public interface IGisOrtakDAO {
	...
	public abstract boolean readHmaxByPlanID(Plan plan,KadastroParsel parsel);
	...
	public abstract List<Adres> readAllAdresByID(Long id, KurumSabit kurumSabit);
	...
	public abstract List<Bina> readAllBinaByID(Long id, KurumSabit kurumSabit);
